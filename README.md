...
| Paralelo | **816.97** VES/USD |
| Brecha · Spread | **10.9%** |
| Binance P2P USDT/VES | **852.70** VES/USDT (+4.4% vs paralelo) |
| **Pronóstico 24h · 24h Forecast** | **↑ Ensanchando · Widening (48%)** |
| Actualizado · Updated | 2026-07-19 21:28 UTC |
...
|---|---|---|---|
| naive (baseline) | 0.709 ± 0.065 | — | 61 |
| stat | 0.688 ± 0.053 | −0.021 ≈ | 61 |
